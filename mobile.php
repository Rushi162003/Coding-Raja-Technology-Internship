                    ...
                    <form id="filterForm" method="post">
                        <div class="animation">
                            ...
                            <select name="cartegory" id="category">
                                ...
                                $sql1 = "SELECT DISTINCT catagory FROM products WHERE catagory='electronics'";
                            ...
                            <select name="product" id="product">
                                ...
                                $database = "e-commerce";
                                $conn = new mysqli($servename, $username, $password, $database);
                                $sql1 = "SELECT DISTINCT product FROM products WHERE product='phone'";
                                $result1 = mysqli_query($conn, $sql1);
                                if ($result1->num_rows > 0) {
                                    while ($row = $result1->fetch_assoc()) {
                                        $product = $row['product'];
                            ...
                            <select name="brand" id="brand">
                                ...
                                $database = "e-commerce";
                                $conn = new mysqli($servename, $username, $password, $database);
                                $sql1 = "SELECT DISTINCT brand FROM products WHERE product='phone'";
                                $result1 = mysqli_query($conn, $sql1);
                                if ($result1->num_rows > 0) {
                                    while ($row = $result1->fetch_assoc()) {
                                        $brand = $row['brand'];
...
<hr>
            ...
            <div id="maindiv" class="col-sm-10 row">
                ...
                if (!$conn) {
                    ...
                    $sql5 = "SELECT * FROM products WHERE product='$product' AND 1=1";
